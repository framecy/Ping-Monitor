...
const i18n = {
    en: {
        ...
        'hero.desc':           'Every millisecond. Every hop. Every host — plus read-only inventory for your whole tailnet. PingMonitor turns raw network noise into a precise, living dashboard, right in your menu bar.',
        ...
        'mockup.nav.monitor':  'Monitor',
        'mockup.nav.stats':    'Stats',
        'mockup.nav.trace':    'Trace',
        'mockup.nav.speed':    'Speed',
        'mockup.nav.tailnet':  'Tailnet',
    ...
    zh: {
        ...
        'hero.desc':           '每一毫秒。每一跳。每一台主机，以及整个 tailnet 的只读设备清单。PingMonitor 将原始网络噪声转化为精准、鲜活的仪表盘——就在你的菜单栏里。',

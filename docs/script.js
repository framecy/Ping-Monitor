...
const i18n = {
    en: {
        ...
        'bento.quick.desc':    'Web, SSH, and custom service shortcuts grouped by host. Enable Tailscale tools only when needed, resize the persistent sidebar, and keep Bark remote push one click away.',
    ...
    zh: {
        ...
        'bento.quick.desc':    '按主机分组的 Web、SSH 与自定义服务快捷方式。Tailscale 工具可按需启用，侧边栏宽度可调并持久保留，Bark 远程推送依旧一键直达。',
        'spec.lang.title':     '语言',
